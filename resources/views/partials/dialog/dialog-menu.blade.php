{{-- Dialow when browse button is hovered or clicked --}}
    ...
    <ul class="py-2">
        <li class="w-100 overflow-hidden px-4 py-2 hover:bg-zeembi-gray">
            <a href="#" class="w-100 group/link p-2 flex items-center text-lg transition-all duration-75 ">
                <span class="w-100 text-truncate group-hover/link:underline text-white">
                Horrors
                </span>
                <svg class="group-hover/link:translate-x-0.5 transition-all duration-75" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>                
            </a>
        </li>
